...
def reshape_dataset(ds, new_shape=[3,3,2]):
    """
...
# batch_size = df_train.Count().GetValue() // 512 # 15
batch_size = 64
batches_in_memory = 1000 # Not rly used? IDK
...
# def time_dataset(ds, n=1000, warmup=50):
...
# raw_batched = train_ds

# input_s_per_batch = time_dataset(raw_batched)
