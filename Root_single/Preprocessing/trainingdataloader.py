from Root_single.Preprocessing.dataloader import RootDataLoader
from Root_single.Preprocessing.trainingdatahelper import (_group_sample_into_threshold_bins,
...
class RootDataSet:
    ...
    def save_to_root(self, path) -> None:
        self.final_df.Display().Print()
        self.final_df.Snapshot("tree", path)
...
if __name__ == "__main__":
    ...
    rds.load()
    rds.save_to_root(
        "Root_single/Data/processed.root"
    )